...
export class EditarProveedores implements OnInit {
  ...
  bancos: any[] = [
    { nombre: 'BANCO AGRÍCOLA', codigo: '001' },
    { nombre: 'BANCO DAVIVIENDA', codigo: '005' },
    { nombre: 'BANCO CUSCATLAN', codigo: '009' },
    { nombre: 'BANCO SCOTIABANK', codigo: '021' },
    { nombre: 'BANCO G&T CONTINENTAL', codigo: '030' },
    { nombre: 'BANCO INDUSTRIAL', codigo: '032' },
    { nombre: 'CITIBANK NA SUC EL SALV', codigo: '037' },
    { nombre: 'BAC CREDOMATIC', codigo: '025' },
    { nombre: 'BANCO PROMERICA', codigo: '018' },
  ];
